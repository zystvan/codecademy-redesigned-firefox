...
//});
//
//var userUsername = unsafeWindow.CCDATA.user.username,
//    userDiscussProfileLink = "http://discuss.codecademy.com/users/" + userUsername + "/activity",
//    userName = $('.grid-col-6.grid-col--center.grid-col--align-center.grid-col--extra-margin-top h3').text();
//
//$('.grid-col-6.grid-col--center.grid-col--align-center.grid-col--extra-margin-top h3').html('<a href="' + userDiscussProfileLink + '" title="Open user profile in Discuss">' + userName + '</a>');
//
